...
public class AddActivityKg extends AppCompatActivity implements View.OnClickListener {
    ...
    private EditText  txtbobot_beli, txttinggi_hewan, status_hewan;
    String txtharga_beli;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        angka_pertama = (EditText) findViewById(R.id.bobot_belikg);
        angka_kedua = (EditText) findViewById(R.id.harga_kg);
////////
        //  setContentView(R.layout.activity_add_kg);
       //5t3 txtharga_beli = (EditText) findViewById(R.id.harga_beli);
     ///  txtbobot_beli = (EditText) findViewById(R.id.bobot_beli);
        ...
        hasil = (EditText) findViewById(R.id.harga_beli);


        angka_kedua.addTextChangedListener(new TextWatcher() {
            @Override
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                if (!angka_pertama.getText().toString().isEmpty()&& !s.toString().isEmpty()){
                    Integer angka1 = Integer.parseInt(angka_pertama.getText().toString());
                    Integer angka2 = Integer.parseInt(s.toString());
                    Integer result = angka1 * angka2;

                    hasil.setText(Integer.toString(result));

                    txtharga_beli = (hasil.getText().toString());
        ...
        angka_pertama.addTextChangedListener(new TextWatcher() {
            @Override
            public void beforeTextChanged(CharSequence s, int start, int count, int after) {
            }
            ...
            @Override
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                if (!angka_kedua.getText().toString().isEmpty() && !s.toString().isEmpty()){
                    int angka1 = Integer.parseInt(angka_kedua.getText().toString());
                    Integer angka2 = Integer.parseInt(s.toString());
                    Integer result = angka1 * angka2;
                    hasil.setText(Integer.toString(result));
        ...
        spNamen2.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                Toast.makeText(AddActivityKg.this, "Selected " + adapterjenkel.getItem(i), Toast.LENGTH_SHORT).show();
        ...
        spkategori.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                Toast.makeText(AddActivityKg.this, "Selected " + spkategori.getSelectedItem(), Toast.LENGTH_SHORT).show();
...
//                Log.d(String.valueOf(id_kategori), "id_kategori");
    ...
    protected void onStart() {
        ...
        super.onStart();
        AddActivityKg.BackTask bt = new AddActivityKg.BackTask();
        AddActivityKg.status st = new AddActivityKg.status();
        st.execute();
        bt.execute();
    ...
    private class status extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            try {
                ...
                //HttpPost httppost = new HttpPost("http://192.168.0.20/connectandroid/includes/combostatus.php");
                HttpResponse response = httpclient.execute(httppost);
                HttpEntity entity = response.getEntity();
                // Get our response as a String.
    ...
    private void tambahbeli() {
        ...
        final String bobot_beli = angka_pertama.getText().toString().trim();
        final String harga_beli = txtharga_beli.trim();
        ...
        Toast.makeText(AddActivityKg.this, "id_kategori " + id_kategori, Toast.LENGTH_SHORT).show();
...
//        }
        ...
        Toast.makeText(AddActivityKg.this, "Status " + id_status, Toast.LENGTH_SHORT).show();

        //
        int hasilbobot = Integer.parseInt(bobot_beli);
            id_bobot = 1;        if (hasilbobot <= 300) {
