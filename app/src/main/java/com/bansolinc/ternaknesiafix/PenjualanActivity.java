...
public class PenjualanActivity extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener,
...
public static final String url_data = BASE_URL+"tampilpenjualan.php/";
   public static final String url_cari = BASE_URL+"cari_data_penjualan.php/";
   ...
   // public static final String url_cari = "http://trickyserver.ddns.net/connectandroid/includes/cari_data_penjualan.php/";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list_view = (ListView) findViewById(R.id.list_view_penjualan);

        adapter = new AdapterJual(PenjualanActivity.this, listData);
    ...
    private void callData() {
        ...
        JsonArrayRequest jArr = new JsonArrayRequest(url_data, new Response.Listener<JSONArray>() {
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(PenjualanActivity.this, error.getMessage(), Toast.LENGTH_LONG).show();
                swipe.setRefreshing(false);
            }
        });
    ...
    public boolean onCreateOptionsMenu(android.view.Menu menu) {
        //getMenuInflater().inflate(R.menu.main_menu_penjualan, menu);
       // final MenuItem item = menu.findItem(R.id.action_search_penjualan);
