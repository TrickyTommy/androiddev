...
public class AdapterJualBeli extends BaseAdapter {
    private Activity activity;
    private LayoutInflater inflater;
    private List<DataModel> item;

    public AdapterJualBeli(Activity activity, List<DataModel> item) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null)
            convertView = inflater.inflate(R.layout.content_laba_rugi, null);

        TextView txt_id = (TextView) convertView.findViewById(R.id.view_idHewan);
        TextView txt_nama = (TextView) convertView.findViewById(R.id.view_kategorihewan);
        TextView txt_hargaBeli = (TextView) convertView.findViewById(R.id.view_tabelbeli);
        TextView txt_hargaJual = (TextView) convertView.findViewById(R.id.view_tabeljual);
...
//        TextView txt_tanggalPembelian = (TextView) convertView.findViewById(R.id.viewtanggal_belijual);
        TextView txt_tanggalPenjualan = (TextView) convertView.findViewById(R.id.view_tabeltanggal);
